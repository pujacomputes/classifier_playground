...
def arg_parser():
    ...
    parser.add_argument(
        '--model_1_ckpt',
        type=str,
        default='/usr/workspace/trivedi1/clip_ckpts/lp+domainnet-sketch_clip-RN50_lp_randaug_test_200_1.0_0.0_0_-1.0_-1.0_-1.0_0_final_checkpoint_200_pth.tar'
    )
    
    parser.add_argument(
        '--model_2_ckpt',
        type=str,
        default='/usr/workspace/trivedi1/clip_ckpts/lp+domainnet-sketch_clip-RN50_lp_test_test_200_3e-05_0.0_1_-1.0_-1.0_-1_1_final_checkpoint_200_pth.tar'
    )
    parser.add_argument(
        '--dataset_1_trainaug',
        type=str,
